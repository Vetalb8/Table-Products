(function () {
  ...
  TABLE.views.editTemplateView = (function () {
    ...
    */
    function _renderWindow(tmplModel) {
      var editModalWindowHtml = $('#modalWindowProduct').html();
      tmpl = _.template(editModalWindowHtml);
      // Fill template obj
      editModalWindowHtml = generateHtml(tmplModel);
      // Show overlay
      overlay.fadeIn(400);
      // Add element on page
      pageBody.append(editModalWindowHtml);
      // Add animate
